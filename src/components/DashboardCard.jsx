...
function DashboardCard({ title, desc, refLink }) {
  ...
  return (
    <div
      className={`flex flex-col h-full w-full place-items-center rounded-lg text-shadow-sm ${daltonismo === "normal"
    ...
    >
      <div
        class={`h-full max-w-lg p-6 rounded-lg ${daltonismo === "normal"
