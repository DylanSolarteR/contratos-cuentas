...
function PlantillaBuilder({ plantilla }) {
  ...
  return (
    <main className="flex flex-col w-full">
      <nav
        className={`flex justify-between border-b-2 p-4 gap-3 items-center text-light-texto dark:text-dark-texto ${
          daltonismo === "normal"
      ...
      <div className="flex w-full flex-grow items-center justify-center relative overflow-y-auto h-[200px] bg-light-fondo dark:bg-dark-fondo bg-[url(/paper.svg)] dark:bg-[url(/paper-dark.svg)]"></div>
    </main>
  );
}
